...
| **full font fidelity (emoji/RTL)** | 基础拉丁/CJK 覆盖完成; emoji/RTL 字体未加入 | 可选扩展 (R2-6 deferred) |
...
| **emoji/RTL 字体扩展** (R2-6) | 当前字体集覆盖拉丁 + CJK（24 fonts），emoji 和 Arabic/Hebrew RTL 是可选扩展 | 用户报告特定语言/字符缺失 |
...
| 4 | E2E | `pnpm run test:e2e:smoke` | ✅ 9/9 PASS |
| 5 | CDP smoke | `pnpm run smoke:onlyoffice` | ✅ 13/13 PASS |
...
### Phase 2: E2E 深度验证 (Playwright, ~4h)
